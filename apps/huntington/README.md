...
Provider behavior is in `huntington_site.py`; the command orchestration is in
`huntington_docs.py`. The storage specification and document rules define naming
