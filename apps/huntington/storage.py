...
ALL_CATEGORIES = [STATEMENT, ESCROW, TAX, CORRESPONDENCE]
...
SPEC = AppSpec(
    ...
    folders=[
        ...
        Folder("escrow_analyses", "Escrow Analyses"),
        Folder("tax_documents", "Tax Documents"),
        Folder("correspondence", "Correspondence"),
    ...
    routes={
        ...
        ESCROW: "escrow_analyses",
        TAX: "tax_documents",
        CORRESPONDENCE: "correspondence",
    },
    default_route="other_documents",
    csv_files=[
        CsvSpec("document_index_csv", "Huntington Bank Document Index.csv",
                DOCUMENT_INDEX_COLUMNS),
    ],
    config_defaults={
        "pilot_count": 5,
    ...
    base_url="https://onlinebanking.huntington.com/",
