...
import capitalone_docs as docs
import capitalone_site as site


@pytest.mark.parametrize("url", ["http://myaccounts.capitalone.com/", "https://myaccounts.capitalone.com.example.org/",
    "https://myaccounts.capitalone.com" + "@" + "evil.example/", "https://myaccounts.capitalone.com:444/", "file:///example"])
...
def test_open_browser_uses_its_own_profile_and_upstream_launcher(tmp_path, monkeypatch):
    ...
    assert config["cdp_url"] == "http://127.0.0.1:9247"
