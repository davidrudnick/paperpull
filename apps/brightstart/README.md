...
Provider behavior is in `brightstart_site.py`; the command orchestration is in
`brightstart_docs.py`. The storage specification and document rules define naming
